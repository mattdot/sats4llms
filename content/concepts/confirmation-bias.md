...
[[sources/riley-sats-cybersecurity-2024|Riley: SATs in Cybersecurity (2024)]] names confirmation bias explicitly as a target of SATs in cybersecurity contexts.

[[sources/tradecraft-primer-2009|CIA Tradecraft Primer (2009)]] describes the mechanism under "mind-set" and "consistency bias" without using the term directly:
...
- **[[concepts/analysis-of-competing-hypotheses|Analysis of Competing Hypotheses (ACH)]]** — the primary technical counter; disconfirmation focus; forces evaluation of all evidence against all hypotheses simultaneously
- **[[concepts/devils-advocacy|Devil's Advocacy]]** — institutionally assigns the task of disconfirming the dominant view
- **[[concepts/key-assumptions-check|Key Assumptions Check]]** — surfaces the assumptions that confirmation bias protects
- **[[concepts/team-a-team-b|Team A/Team B]]** — separates analysts so one team can't contaminate the other with confirming reasoning chains
...
[[concepts/cognitive-bias|Cognitive Bias]] | [[concepts/motivated-reasoning|Motivated Reasoning]] | [[concepts/groupthink|Groupthink]] | [[concepts/mind-set|Mind-Set]] | [[concepts/anchoring-bias|Anchoring Bias]]
