...
Mind-sets are:
1. **Necessary** — allow individuals to process an otherwise incomprehensible volume of information
2. **Unconscious** — rarely examined and almost never challenged by those who hold them
3. **Self-reinforcing** — confirming information is absorbed; disconfirming information is dismissed
4. **Sticky** — resistant to change even when confronted with new evidence
...
1. Analysts perceive what they *expect* to perceive
2. Once formed, mind-sets are resistant to change
3. New information is assimilated (sometimes erroneously) into existing mind-sets
4. Conflicting information is often dismissed or ignored
